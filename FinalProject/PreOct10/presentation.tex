...
\begin{itemize}
\item \textbf{Stock price prediction:} Previous studies have mostly focused on low frequency \cite{Kearns2013}. \textcolor{red}{Machine Learning + Big Data = High Frequency}.
\item \textbf{Goal:} Predict stock price solely based on price and volume data (of its own and other stocks), without fundamental analysis.
\item \textbf{Data:} 
\begin{itemize}
\item Minute-level US equity pricing and volume data since 2002. Five minute window.
...
\item 2002-2017 as training set, 2017-2018 as test set.
\end{itemize}
\end{itemize}
\end{frame}
